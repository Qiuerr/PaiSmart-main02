...
public class JwtUtilsRefreshTest {
    ...
    @Mock
    private TokenCacheService tokenCacheService; // 模拟这个 Service
    ...
    void setUp() {
        ...
        lenient().when(tokenCacheService.isTokenValid(org.mockito.Mockito.anyString())).thenReturn(true);
        lenient().when(tokenCacheService.isRefreshTokenValid(org.mockito.Mockito.anyString())).thenReturn(true);
    }
